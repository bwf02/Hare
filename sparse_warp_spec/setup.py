...
class CustomBuildPy(build_py):
    ...
    def generate_default_envs(self):
        ...
        with open(os.path.join(self.build_lib, 'sparse_gemm', 'envs.py'), 'w') as f:
            f.write(code)

    def prepare_includes(self):
        # Create temporary build directory instead of modifying package directory
        build_include_dir = os.path.join(self.build_lib, 'sparse_gemm/include')
...
if __name__ == '__main__':
    ...
    setuptools.setup(
        ...
        ext_modules=[
            CppExtension(name='sparse_gemm_cpp',
                         sources=sources,
