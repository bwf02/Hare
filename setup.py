...
setup(
    name="hare",
    version="1.0.0",
    description="Kernel Library for hare format generation",
    author="Weifeng Bu",
    author_email="weifengbu@stu.xidian.edu.cn",
    packages=find_packages(),
    license="MIT",
    ext_modules=[
        CMakeExtension("megablocks_ops"),#这个名字用来自己看 对c++的编译没有影响
        CMakeExtension("hare_ops"),
    ],
