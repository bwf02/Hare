...
if __name__ == "__main__":
    file_name = "../model/result/b1_seq4096_model_flash.csv"
    output_file = "./figures/prefill_model.pdf"
    ...
    # 2. 绘图
    figure_size = (8, 3.6)
    subfigure_args = {'left':0.06, 'right':0.99, 'top':0.89, 'bottom':0.18, 'wspace':0.08}
    xlabel = "Model"
